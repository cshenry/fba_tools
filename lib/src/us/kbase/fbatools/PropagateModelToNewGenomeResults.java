...
/**
 * <p>Original spec-file type: PropagateModelToNewGenomeResults</p>
 * 
 * 
 */
...
public class PropagateModelToNewGenomeResults {
    ...
    public PropagateModelToNewGenomeResults withNewFbamodelRef(String newFbamodelRef) {
        this.newFbamodelRef = newFbamodelRef;
        return this;
    }
    ...
    public PropagateModelToNewGenomeResults withNewFbaRef(String newFbaRef) {
        this.newFbaRef = newFbaRef;
        return this;
    }
    ...
    public PropagateModelToNewGenomeResults withNumberGapfilledReactions(Long numberGapfilledReactions) {
        this.numberGapfilledReactions = numberGapfilledReactions;
        return this;
    }
    ...
    public PropagateModelToNewGenomeResults withNumberRemovedBiomassCompounds(Long numberRemovedBiomassCompounds) {
        this.numberRemovedBiomassCompounds = numberRemovedBiomassCompounds;
        return this;
    }
    ...
    public String toString() {
        return ((((((((((("PropagateModelToNewGenomeResults"+" [newFbamodelRef=")+ newFbamodelRef)+", newFbaRef=")+ newFbaRef)+", numberGapfilledReactions=")+ numberGapfilledReactions)+", numberRemovedBiomassCompounds=")+ numberRemovedBiomassCompounds)+", additionalProperties=")+ additionalProperties)+"]");
    }
