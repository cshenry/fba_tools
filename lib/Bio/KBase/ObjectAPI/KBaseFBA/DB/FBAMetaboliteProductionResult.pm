########################################################################
# Bio::KBase::ObjectAPI::KBaseFBA::DB::FBAMetaboliteProductionResult - This is the moose object corresponding to the KBaseFBA.FBAMetaboliteProductionResult object
# Authors: Christopher Henry, Scott Devoid, Paul Frybarger
# Contact email: chenry@mcs.anl.gov
# Development location: Mathematics and Computer Science Division, Argonne National Lab
########################################################################
package Bio::KBase::ObjectAPI::KBaseFBA::DB::FBAMetaboliteProductionResult;
...
# CONSTANTS:
sub _type { return 'KBaseFBA.FBAMetaboliteProductionResult'; }
sub _module { return 'KBaseFBA'; }
sub _class { return 'FBAMetaboliteProductionResult'; }
sub _top { return 0; }
...
my $attribute_map = {modelcompound_ref => 0, maximumProduction => 1};
sub _attributes {
	 my ($self, $key) = @_;
	 if (defined($key)) {
