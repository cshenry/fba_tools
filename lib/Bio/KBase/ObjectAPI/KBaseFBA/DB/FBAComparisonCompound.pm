########################################################################
# Bio::KBase::ObjectAPI::KBaseFBA::DB::FBAComparisonCompound - This is the moose object corresponding to the KBaseFBA.FBAComparisonCompound object
# Authors: Christopher Henry, Scott Devoid, Paul Frybarger
# Contact email: chenry@mcs.anl.gov
# Development location: Mathematics and Computer Science Division, Argonne National Lab
########################################################################
package Bio::KBase::ObjectAPI::KBaseFBA::DB::FBAComparisonCompound;
...
has exchanges => (is => 'rw', isa => 'HashRef', printOrder => '-1', default => sub {return {};}, type => 'attribute', metaclass => 'Typed');
...
# CONSTANTS:
sub _type { return 'KBaseFBA.FBAComparisonCompound'; }
sub _module { return 'KBaseFBA'; }
sub _class { return 'FBAComparisonCompound'; }
sub _top { return 0; }
...
my $attribute_map = {state_conservation => 0, exchanges => 1, name => 2, most_common_state => 3, charge => 4, formula => 5, id => 6};
sub _attributes {
	 my ($self, $key) = @_;
	 if (defined($key)) {
