########################################################################
# Bio::KBase::ObjectAPI::KBaseExpression::DB::RNASeqSample - This is the moose object corresponding to the KBaseExpression.RNASeqSample object
# Authors: Christopher Henry, Scott Devoid, Paul Frybarger
# Contact email: chenry@mcs.anl.gov
# Development location: Mathematics and Computer Science Division, Argonne National Lab
########################################################################
package Bio::KBase::ObjectAPI::KBaseExpression::DB::RNASeqSample;
...
# CONSTANTS:
sub _type { return 'KBaseExpression.RNASeqSample'; }
sub _module { return 'KBaseExpression'; }
sub _class { return 'RNASeqSample'; }
sub _top { return 0; }
...
my $attribute_map = {shock_ref => 0, created => 1, name => 2, type => 3};
sub _attributes {
	 my ($self, $key) = @_;
	 if (defined($key)) {
