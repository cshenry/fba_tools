########################################################################
# Bio::KBase::ObjectAPI::ProbabilisticAnnotation::DB::ProbAnno - This is the moose object corresponding to the ProbabilisticAnnotation.ProbAnno object
# Authors: Christopher Henry, Scott Devoid, Paul Frybarger
# Contact email: chenry@mcs.anl.gov
# Development location: Mathematics and Computer Science Division, Argonne National Lab
########################################################################
package Bio::KBase::ObjectAPI::ProbabilisticAnnotation::DB::ProbAnno;
...
has roleset_probabilities => (is => 'rw', isa => 'ArrayRef', printOrder => '-1', default => sub {return [];}, type => 'attribute', metaclass => 'Typed');
...
sub _type { return 'ProbabilisticAnnotation.ProbAnno'; }
sub _module { return 'ProbabilisticAnnotation'; }
sub _class { return 'ProbAnno'; }
sub _top { return 1; }
...
my $attribute_map = {skipped_features => 0, roleset_probabilities => 1, id => 2, genome_workspace => 3, genome => 4};
sub _attributes {
	 my ($self, $key) = @_;
	 if (defined($key)) {
