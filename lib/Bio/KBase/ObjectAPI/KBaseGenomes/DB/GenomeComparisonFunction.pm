########################################################################
# Bio::KBase::ObjectAPI::KBaseGenomes::DB::GenomeComparisonFunction - This is the moose object corresponding to the KBaseGenomes.GenomeComparisonFunction object
# Authors: Christopher Henry, Scott Devoid, Paul Frybarger
# Contact email: chenry@mcs.anl.gov
# Development location: Mathematics and Computer Science Division, Argonne National Lab
########################################################################
package Bio::KBase::ObjectAPI::KBaseGenomes::DB::GenomeComparisonFunction;
...
has core => (is => 'rw', isa => 'Int', printOrder => '-1', type => 'attribute', metaclass => 'Typed');
...
# CONSTANTS:
sub _type { return 'KBaseGenomes.GenomeComparisonFunction'; }
sub _module { return 'KBaseGenomes'; }
sub _class { return 'GenomeComparisonFunction'; }
sub _top { return 0; }
