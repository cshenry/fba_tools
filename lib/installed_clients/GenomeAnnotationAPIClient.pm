package installed_clients::GenomeAnnotationAPIClient;
...
installed_clients::GenomeAnnotationAPIClient
...
sub new
{
    ...
    my $self = {
	client => installed_clients::GenomeAnnotationAPIClient::RpcClient->new,
	url => $url,
	headers => [],
    };
    my %arg_hash = @args;
...
sub _validate_version {
    ...
    if ($sMinor > $cMinor) {
        warn "New client version available for installed_clients::GenomeAnnotationAPIClient\n";
    }
    if ($sMajor == 0) {
        warn "installed_clients::GenomeAnnotationAPIClient version is $svr_version. API subject to change.\n";
    }
}
...
package installed_clients::GenomeAnnotationAPIClient::RpcClient;
