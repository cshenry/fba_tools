package installed_clients::GenomeAnnotationAPIServiceClient;
...
installed_clients::GenomeAnnotationAPIServiceClient
...
sub new
{
    ...
    my $self = {
	client => installed_clients::GenomeAnnotationAPIServiceClient::RpcClient->new,
	url => $url,
	headers => [],
    };
...
sub _validate_version {
    ...
    if ($sMinor > $cMinor) {
        warn "New client version available for installed_clients::GenomeAnnotationAPIServiceClient\n";
    }
    if ($sMajor == 0) {
        warn "installed_clients::GenomeAnnotationAPIServiceClient version is $svr_version. API subject to change.\n";
    }
}
...
package installed_clients::GenomeAnnotationAPIServiceClient::RpcClient;
